...
use PLATFORMBundle\Entity\Location;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $locations = $em->getRepository('PLATFORMBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PLATFORMBundle\Form\LocationType', $location);
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('PLATFORMBundle\Form\LocationType', $location);
